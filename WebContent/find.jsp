            ...
            <div class="page">
                <form class="find_page">
                    ...
                    <div class="menu_accordion">
                        <div style="display:flex;"><button type="button" class="accordion" onclick="display_block_a_1()">Année 1</button><i class="fas fa-angle-double-up icon_accordion a_1"></i></div>
                        <div class="panel">

                            <div style="display:flex;"><button type="button" class="accordion" onclick="display_block_a_1_e()">Électronique</button><i class="fas fa-angle-double-up icon_accordion_2 a_1_e"></i></div>
                            <div class="panel">

                                <ul>
                                    <li class="list_accordion"><b>IE2409 :</b> Microsystèmes Électroniques<a style="float:right" href="#"><i class="fas fa-edit icon_module edit"></i><i class="fas fa-eye icon_module"></i></a></li>
                                    <li class="list_accordion"><b>IE2410 :</b> Microsystèmes Informatiques<a style="float:right" href="#"><i class="fas fa-edit icon_module edit"></i><i class="fas fa-eye icon_module"></i></a></li>
                                </ul>
                        ...
                        <div style="display:flex;"><button class="accordion">Année 2</button><i class="fas fa-angle-double-up icon_accordion"></i></div>
                        
                        <div style="display:flex;"><button class="accordion">Année 3</button><i class="fas fa-angle-double-up icon_accordion"></i></div>
