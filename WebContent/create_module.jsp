            ...
            <div class="page">
                ...
                <div class="input_module_container">
                    <form action="sucess.html" method="post">
                        ...
                        <label>Titre du module</label><i class="fas fa-circle oblig_field"></i>
                        <div style="display: flex; margin-bottom: 16px;">
                            <input id="field_1" autocomplete="off" onchange="check_field_1()" class="input_create_module" placeholder="Entrez le nom de votre module">
                            <i id="check_1" class="fas fa-check-circle check_module"></i>
                            <span class="ok_popup" id="ok_1">ok</span>
                        </div>
                        
                        <label>Identifiant du module</label><i class="fas fa-circle oblig_field"></i>
                        <div style="display: flex; margin-bottom: 16px;">
                            <input id="field_2" autocomplete="off" onchange="check_field_2()" class="input_create_module" placeholder="Entrez l'identifiant de votre module">
                            <i id="check_2" class="fas fa-check-circle check_module"></i>
                            <span class="ok_popup" id="ok_2">ok</span>
                        </div>
                        
                        <label>Responsable du module</label><i class="fas fa-circle oblig_field"></i>
                        <div style="display: flex; margin-bottom: 16px;">
                            <input id="field_3" autocomplete="off" onchange="check_field_3()" class="input_create_module" placeholder="Entrez le nom du responsable du module">
                            <i id="check_3" class="fas fa-check-circle check_module"></i>
                            <span class="ok_popup" id="ok_3">ok</span>
                        </div>
                        
                        <label>Nombre de cr&#233;dits ECTS</label><i class="fas fa-circle oblig_field"></i>
                        <div style="display: flex; margin-bottom: 16px;">
                            <i type="button" onclick="add_field_4()" class="fas fa-plus-circle button_add"></i>
                            <i type="button" onclick="remove_field_4()" class="fas fa-minus-circle button_add"></i>
                            <input id="field_4" autocomplete="off" onchange="check_field_4()" class="input_create_module" value="0" style="margin-left: 15px;">
                            <i id="check_4" class="fas fa-check-circle check_module"></i>
                            <span class="ok_popup" id="ok_4">ok</span>
                        </div>
                        
                        <label>Quantit&#233; de travail par &#233;lève</label><i class="fas fa-circle oblig_field"></i>
                        <div style="display: flex; margin-bottom: 16px;">
                            <i type="button" onclick="add_field_5()" class="fas fa-plus-circle button_add"></i>
                            <i type="button" onclick="remove_field_5()" class="fas fa-minus-circle button_add"></i>
                            <input id="field_5" autocomplete="off" onchange="check_field_5()" class="input_create_module" value="0" style="margin-left: 15px;">
                            <i id="check_5" class="fas fa-check-circle check_module"></i>
                            <span class="ok_popup" id="ok_5">ok</span>
                        </div>
                        
                        <label>Travail par &#233;quipe</label><i class="fas fa-circle oblig_field"></i>
                        <div style="display: flex; margin-bottom: 16px;">
                            
                            <label class="container_check" style="margin-right: 30px;">Oui
                                <input onchange="check_box_field()" id="Mycheck_1" type="checkbox" style="width:0px;" checked>
                                <span class="checkmark check_yesno"></span>
                            </label>
                            <label class="container_check">Non
                                <input onchange="check_box_field_2()" id="Mycheck_2" type="checkbox" style="width:0px;">
                                <span class="checkmark check_yesno"></span>
                            </label>
                        </div>
                        
                        <label>Mots Clefs</label><i class="fas fa-circle oblig_field"></i>
                        <div style="display: flex; margin-bottom: 16px;"><input class="input_create_module" autocomplete="off" placeholder="Ajouter un mot clef"><i class="fas fa-check-circle check_module"></i></div>
                        ...
                        <div id="step_2" style="margin-right: -700px; padding-left: 700px; display: none; transition: 1s; opacity: 1;">
                            ...
                            <label>Pr&#233;sentation</label><i class="fas fa-circle oblig_field"></i>
                            <div style="margin-bottom: 16px;">
                                <textarea class="textarea_module" style="height:170px;" placeholder="Entrez une description d&#233;taill&#233;e de votre module"></textarea>
                            </div>
                        ...
                        <div id="step_3" style="margin-right: -700px; padding-left: 700px; display: none; transition: 1s; opacity: 1;">
                            ...
                            <label>Objectifs P&#233;dagogiques</label><i class="fas fa-circle oblig_field"></i>
                            <div style="margin-bottom: 16px;">
                                <textarea class="textarea_module" style="height:170px;" placeholder="Entrez les diff&#233;rents objectifs p&#233;dagogiques de votre module"></textarea>
                            </div>
                        ...
                        <div id="step_4" style="margin-right: -700px; padding-left: 700px; display: none; transition: 1s; opacity: 1;">
                            ...
                            <label>Modalit&#233;s P&#233;dagogiques</label><i class="fas fa-circle oblig_field"></i>
                            <div style="margin-bottom: 16px;">
                                <textarea class="textarea_module" style="height:170px;" placeholder="Entrez les diff&#233;rentes modalit&#233;s p&#233;dagogiques de votre module"></textarea>
                            </div>
